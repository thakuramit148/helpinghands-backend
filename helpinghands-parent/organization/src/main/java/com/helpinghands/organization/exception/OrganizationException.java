package com.helpinghands.organization.exception;
...
@ControllerAdvice
public class OrganizationException extends ResponseEntityExceptionHandler {

	private static Logger logger = LoggerFactory.getLogger(OrganizationException.class);
